var tipuesearch = {
  pages: [
    {
      title:
        '<p>IMS Central</p> <img class="search-icon" aria-label="Internal page" src="wp-content/search_internalpage.svg"></img>',
    ...
    {
      title:
        '<p>APIs</p> <img class="search-icon" aria-label="Internal page" src="wp-content/search_internalpage.svg"></img>',
    ...
    {
      title:
        '<p>Automation with Ansible</p> <img class="search-icon" aria-label="Internal page" src="wp-content/search_internalpage.svg"></img>',
    ...
    {
      title:
        '<p>Java</p> <img class="search-icon" aria-label="Internal page" src="wp-content/search_internalpage.svg"></img>',
    ...
    {
      title:
        '<p>IMS Database</p> <img class="search-icon" aria-label="Internal page" src="wp-content/search_internalpage.svg"></img>',
    ...
    {
      title:
        '<p>IMS Gold: Feedback program</p> <img class="search-icon" aria-label="Internal page" src="wp-content/search_internalpage.svg"></img>',
    ...
    {
      title:
        '<p>IMS Community</p> <img class="search-icon" aria-label="External page" src="wp-content/search_externalpage.svg"></img>',
    ...
    {
      title:
        '<p>IMS Courses</p> <img class="search-icon" aria-label="Course" src="wp-content/search_education.svg"></img>',
    ...
    {
      title:
        '<p>IMS Community Calls</p> <img class="search-icon" aria-label="Video" src="wp-content/search_video.svg"></img>',
    ...
    {
      title:
        '<p>Introduction to IMS</p> <img class="search-icon" aria-label="Video" src="wp-content/search_video.svg"></img>',
    ...
    {
      title:
        '<p>Ansible for IMS</p> <img class="search-icon" aria-label="Video" src="wp-content/search_video.svg"></img>',
    ...
    {
      title:
        '<p>IMS Insights Series</p> <img class="search-icon" aria-label="Video" src="wp-content/search_video.svg"></img>',
    ...
    {
      title:
        '<p>IMS Tools</p> <img class="search-icon" aria-label="Video" src="wp-content/search_video.svg"></img>',
    ...
    {
      title:
        '<p>Intro to IMS Catalog</p> <img class="search-icon" aria-label="Video" src="wp-content/search_video.svg"></img>',
    ...
    {
      title:
        '<p>IMS Catalog Database Repair and Recovery</p> <img class="search-icon" aria-label="Video" src="wp-content/search_video.svg"></img>',
    ...
    {
      title:
        '<p>IMS Full-Function Log Record Analysis</p> <img class="search-icon" aria-label="Video" src="wp-content/search_video.svg"></img>',
    ...
    {
      title:
        '<p>How to Reorganize the IMS DBRC RECON Data Sets</p> <img class="search-icon" aria-label="Video" src="wp-content/search_video.svg"></img>',
    ...
    {
      title:
        '<p>Managing IMS Buffers</p> <img class="search-icon" aria-label="Video" src="wp-content/search_video.svg"></img>',
    ...
    {
      title:
        '<p>IMS Monitor Reports</p> <img class="search-icon" aria-label="Video" src="wp-content/search_video.svg"></img>',
    ...
    {
      title:
        '<p>IMS and Distributed Environment Security</p> <img class="search-icon" aria-label="Video" src="wp-content/search_video.svg"></img>',
    ...
    {
      title:
        '<p>XCF and Support of IMS Facilities for Shared Queues</p> <img class="search-icon" aria-label="Video" src="wp-content/search_video.svg"></img>',
    ...
    {
      title:
        '<p>Tuning IMS Scheduling using PWFI</p> <img class="search-icon" aria-label="Video" src="wp-content/search_video.svg"></img>',
    ...
    {
      title:
        '<p>Java IMS Demos</p> <img class="search-icon" aria-label="Video" src="wp-content/search_video.svg"></img>',
    ...
    {
      title:
        '<p>IMS Explorer</p> <img class="search-icon" aria-label="Video" src="wp-content/search_video.svg"></img>',
    ...
    {
      title:
        '<p>Java and IMS</p> <img class="search-icon" aria-label="Video" src="wp-content/search_video.svg"></img>',
    ...
    {
      title:
        '<p>31-bit COBOL and 64-bit Java Interoperability</p> <img class="search-icon" aria-label="Video" src="wp-content/search_video.svg"></img>',
    ...
    {
      title:
        '<p>IMS Fundamentals</p> <img class="search-icon" aria-label="Course" src="wp-content/search_education.svg"></img>',
    ...
    {
      title:
        '<p>Introduction to the PL/I Programming Language</p> <img class="search-icon" aria-label="Course" src="wp-content/search_education.svg"></img>',
    ...
    {
      title:
        '<p>IMS Logical Relationships</p> <img class="search-icon" aria-label="Course" src="wp-content/search_education.svg"></img>',
      text: "This course covers how to code DBDs and PSBs for databases in logical relationships and adjust database performance.",
      tags: "learn courses badges",
      url: "ims-education.html#ims-logrel",
    },
    {
      title:
        '<p>IMS Database Fundamentals</p> <img class="search-icon" aria-label="Course" src="wp-content/search_education.svg"></img>',
    ...
    {
      title:
        '<p>IMS Database Recovery Control (DBRC)</p> <img class="search-icon" aria-label="Course" src="wp-content/search_education.svg"></img>',
    ...
    {
      title:
        '<p>IMS Data Sharing</p> <img class="search-icon" aria-label="Course" src="wp-content/search_education.svg"></img>',
    ...
    {
      title:
        '<p>IMS High Availability Large Database (HALDB)</p> <img class="search-icon" aria-label="Course" src="wp-content/search_education.svg"></img>',
    ...
    {
      title:
        '<p>IMS Fast Path implementation</p> <img class="search-icon" aria-label="Course" src="wp-content/search_education.svg"></img>',
    ...
    {
      title:
        '<p>IMS Database Repair</p> <img class="search-icon" aria-label="Course" src="wp-content/search_education.svg"></img>',
    ...
    {
      title:
        '<p>IMS Database Performance and Tuning</p> <img class="search-icon" aria-label="Course" src="wp-content/search_education.svg"></img>',
    ...
    {
      title:
        '<p>IMS Physical Organization of Databases</p> <img class="search-icon" aria-label="Course" src="wp-content/search_education.svg"></img>',
      text: "Learn about IMS DB access methods, how to code DBDs and PSBs, how to use IMS DB utilities, and more.",
    ...
    {
      title:
        '<p>Implementing IMS Security</p> <img class="search-icon" aria-label="Course" src="wp-content/search_education.svg"></img>',
      text: "Learn what IMS resources can be protected and what facilities you can use to protect them.",
      tags: "learn courses badges exits racf encryption vsam_password_protection security_parameters",
      url: "ims-education.html#ims-security",
    },
    {
      title:
        '<p>IMS System Programming: DB and TM</p> <img class="search-icon" aria-label="Course" src="wp-content/search_education.svg"></img>',
    ...
    {
      title:
        '<p>IMS Diagnostics</p> <img class="search-icon" aria-label="Course" src="wp-content/search_education.svg"></img>',
    ...
    {
      title:
        '<p>IMS Shared Queues</p> <img class="search-icon" aria-label="Course" src="wp-content/search_education.svg"></img>',
    ...
    {
      title:
        '<p>IMS TM Performance Analysis</p> <img class="search-icon" aria-label="Course" src="wp-content/search_education.svg"></img>',
    ...
    {
      title:
        '<p>IMS DBCTL</p> <img class="search-icon" aria-label="Course" src="wp-content/search_education.svg"></img>',
    ...
    {
      title:
        '<p>IMS TM Application Programming</p> <img class="search-icon" aria-label="Course" src="wp-content/search_education.svg"></img>',
    ...
    {
      title:
        '<p>Database Application Programming</p> <img class="search-icon" aria-label="Course" src="wp-content/search_education.svg"></img>',
