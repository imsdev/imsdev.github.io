...
(function ($) {
  ...
  $.fn.tipuesearch = function (searchInput, searchInputId, options) {
          ...
          if (c != 0) {
            ...
            for (var i = 0; i < found.length; i++) {
              if (l_o >= start && l_o < set.show + start) {
                out +=
                  '<div class="result"><button id="search-dd-arrow" class="cordion" aria-label="Drop-down arrow" tabindex="-1"><i class="fa fa-angle-right" tabindex="0" aria-labelled-by="search-dd-arrow" style="font-size:24px"></i></button><div class="tipue_search_content_title"><a href="' +
                  found[i].url +
                  '"' +
                  tipue_search_w +
                  ">" +
            ...
            if (c > set.show) {
              ...
              if (start > 0) {
                out +=
                  '<li role="navigation"><a class="tipue_search_foot_box" tabindex="0" accesskey="b" id="' +
                  (start - set.show) +
                  "_" +
                  replace +
                  '">' +
              ...
              if (page <= 2) {
                ...
                for (var f = 0; f < p_b; f++) {
                  if (f == page) {
                    ...
                    out +=
                      '<li role="navigation"><a class="tipue_search_foot_box" tabindex="0" id="' +
                      f * set.show +
                      "_" +
                      replace +
                      '">' +
              ...
              if (page + 1 != pages) {
                out +=
                  '<li role="navigation"><a class="tipue_search_foot_box" tabindex="0" accesskey="m" id="' +
                  (start + set.show) +
                  "_" +
                  replace +
                  '">' +
