...
{out+='<div class="result"><button class="cordion"><i class="fa fa-angle-down" style="font-size:24px"></i></button><div class="tipue_search_content_title"><a href="'+found[i].url+'"'+tipue_search_w+'>'+found[i].title+'</a></div></div>';if(set.debug)
