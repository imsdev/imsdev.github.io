          ...
          if (c != 0) {
            ...
            for (var i = 0; i < found.length; i++) {
              if (l_o >= start && l_o < set.show + start) {
                out +=
                  '<div class="result"><button id="search-dd-arrow" tabindex="0" class="cordion" aria-label="Drop-down arrow"><i class="fa fa-angle-right" aria-labelled-by="search-dd-arrow" style="font-size:24px"></i></button><div class="tipue_search_content_title"><a href="' +
                  found[i].url +
                  '"' +
                  tipue_search_w +
                  ">" +
